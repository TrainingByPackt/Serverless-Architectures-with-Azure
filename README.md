[![GitHub issues](https://img.shields.io/github/issues/TrainingByPackt/Serverless-Architectures-with-Azure.svg)](https://github.com/TrainingByPackt/Serverless-Architectures-with-Azure/issues)
